...
package org.elasticsearch.ingest.encoder;
...
import org.elasticsearch.ingest.encoder.aes.AesEncryptProcessor;
...
public class IngestEncoderPlugin extends Plugin implements ActionPlugin, IngestPlugin {
    ...
    public Map<String, Processor.Factory> getProcessors(Processor.Parameters parameters) {
        return Map.ofEntries(
            ...
            entry(AesEncryptProcessor.TYPE, new AesEncryptProcessor.Factory(parameters.scriptService))
